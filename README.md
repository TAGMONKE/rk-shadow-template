# RK Shadow Template
RK Shadow Template is a mod menu template for Gorilla Tag with custom categories and the maximum amount of customization possible. This template is meant for more advanced users, so if you're a new menu creator, this could be difficult for you.
...
- Download the release from [here](https://github.com/TAGMONKE/rk-shadow-template/blob/main/README.md)
